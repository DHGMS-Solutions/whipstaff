namespace Dhgms.Whipstaff.Model.SingleInstance
{
    ...
    public abstract class ArgumentsDeliveryStrategy
    {
        ...
        {
            Action<string[], bool> localArgsNotification = this.argsNotification;  // Create local copy to avoid concurrency issues on cleanup
        ...
        internal void InitializeFirstInstance(string applicationId, Action<string[], bool> argsNotification)
        {
            ...
            this.OnInitializeFirstInstance(applicationId);
        }

        internal void DeliverArgumentsToFirstInstance(string applicationId, string[] args)
        {
            this.OnDeliverArgumentsToFirstInstance(applicationId, args);
        }

        internal void Cleanup()
        {
            this.OnCleanup();
            this.argsNotification = null;
        }
