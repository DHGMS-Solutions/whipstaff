namespace Dhgms.Whipstaff.Model.SingleInstance
{
    ...
    public sealed class SingleInstanceManagerSetup
    {
        ...
        public SingleInstanceManagerSetup(string applicationId)
        {
            ...
            this.TerminationOption = TerminationOption.Exit;
            this.InstanceNotificationOption = InstanceNotificationOption.NotifyAnyway;
            //this.InstanceNotificationOption = InstanceNotificationOption.NotifyOnlyIfAdmin;
        }
